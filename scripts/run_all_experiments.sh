...
echo "  - results/part4/exp3_spatial_only/"
echo "  - results/part4/exp4_spatial_frequency/"
echo "  - results/part4/exp5_spatial_contrastive/"
echo "  - results/part4/exp6_full_model/"
echo ""
echo "Each directory contains:"
echo "  - best_model.pth (best validation model)"
echo "  - final_model.pth (last epoch)"
echo "  - checkpoint_epoch_*.pth (every 5 epochs)"
echo "  - training.log (full log)"
echo "  - tensorboard/ (training curves)"
echo ""
echo "To view tensorboard:"
echo "  tensorboard --logdir results/part4/"
